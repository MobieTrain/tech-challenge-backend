...
export async function create(name: string, bio: string, bornAt: string): Promise<number> {
...
/** @returns whether the ID was actually found */
export async function update(id: number, name: string, bio: string, bornAt: string): Promise<boolean>  {
